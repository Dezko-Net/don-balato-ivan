      ...
      <nav className={`tpl1-bottom-nav${pathname?.startsWith('/inventario') ? ' !hidden' : ''}`}>
        <div className="tpl1-bottom-nav-inner">
          ...
          <div className={`tpl1-fab-bubbles${fabOpen ? ' open' : ''}`}>
            ...
            {/* 📦 Paquete OCULTO (jul 2026): todo pedido es mayorista vía precios por volumen */}
            {false && <div className="tpl1-fab-bubble" onClick={() => { setFabOpen(false); router.push('/paquetes'); }}>
