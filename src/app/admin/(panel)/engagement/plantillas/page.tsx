...
const TEMPLATES: Template[] = [
  ...
  { id: 25, name: 'Plantilla 25 (Concept Theme)', description: 'Diseño ultra moderno con navegación dock móvil, popup de newsletter y carruseles fluidos.', emoji: '📱', tags: ['Concept', 'Shopify', 'Mobile-First'], accent: '#0ea5e9', accentDark: '#0369a1', bg: '#f0f9ff', navBg: '#171717', badge: 'Principal', sections: ['landing', 'collections', 'catalog', 'productDetail'] },
