...
function VerificarStockContent() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Build WhatsApp link directly to customer's phone from order
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">El pedido {code} ya fue confirmado. Este enlace es de un solo uso.</p>
          {waLink ? (
            <>
              ...
              <p className="text-xs text-gray-400">Se abrira WhatsApp con el mensaje listo para enviar al cliente</p>
            </>
          ) : null}
        </div>
      </div>
